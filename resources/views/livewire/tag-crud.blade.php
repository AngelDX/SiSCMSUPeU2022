        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center p-2 rounded-md flex-1">
                <label class="w-full relative text-gray-400 focus-within:text-gray-600 block">
                    ...
                    <x-jet-input type="text" wire:model="search" class="w-full block pl-14" placeholder="Buscar categoria..."/>
                </label>
            </div>
            <!--Boton nuevo   -->
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="text-sm font-medium text-gray-900">
                  ...
                  <td class="px-6 py-4">
                    ...
                    <x-jet-danger-button wire:click="$emit('deleteItem',{{$item}})"> <!-- Usamos metodos magicos -->
            ...
            Swal.fire({
              ...
              confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    //alert(object);
                    Livewire.emitTo('tag-crud','delete',object);
                    Swal.fire(
                        'Deleted!',
